...
const navItems = [
  ...
  },
  {
    to: '/categories',
    label: '分类',
    match: (pathname: string) => pathname.startsWith('/categories') || pathname.startsWith('/category/'),
  },
  {
    to: '/tags',
    label: '标签',
    match: (pathname: string) => pathname.startsWith('/tags') || pathname.startsWith('/tag/'),
  },
]
...
export default function Navbar() {
  ...
  return (
    <>
      <header className={cn('liquid-glass', styles.header)}>
      ...
      {menuOpen && (
        <div className={cn('liquid-glass', 'liquid-glass--dense', styles.mobileMenu)}>
